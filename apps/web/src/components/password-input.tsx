...
const FloatingLabelPasswordInputComponent = React.forwardRef<HTMLInputElement, InputProps>(
    ...
    return (
      <div className="relative">
        <FloatingInput
          ...
          {...props}
        />
        <FloatingLabel htmlFor={id}>Password</FloatingLabel>
        <Button
          type="button"
          variant="ghost"
          size="sm"
...
FloatingLabelPasswordInputComponent.displayName = "FloatingLabelPasswordInput";

export const PasswordInput = PasswordInputComponent;
export const FloatingLabelPasswordInput = FloatingLabelPasswordInputComponent;
